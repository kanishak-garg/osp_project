...
(1, 'General', 'phone'),
(2, 'Covid special', 'phone'),
(3, 'Blood Pressure', 'phone'),
(4, 'Sugar', 'watch'),
(5, 'Machines', 'watch'),
(6, 'ointments', 'watch');
...
(7, 1, 'Samsung s7 edge', '5.50-inch 1440x2560 display powered by 1.6GHz octa-core processor alongside 4GB of RAM and 12-megapixel', 560, 2, 'vega.jpg', ''),
(8, 1, 'Iphone 7', 'Features 3G, 4.7â€³ LED-backlit IPS LCD display, 12 MP camera, Wi-Fi, GPS, Bluetooth', 700, 8, 'vega.jpg', ''),
(9, 2, 'Gopro Hero 5', ' GoPro HERO5 Black features Supports 4K30, 2.7K60, 1080p120 Video, Capture 12MP Photos at 30fps', 450, 9, 'vega.jpg', '1'),
(11, 6, 'Oculus rift', 'The Oculus Rift is a virtual reality system that completely immerses you inside virtual worlds', 600, 10, 'vega.jpg', '1'),
(12, 3, 'MSI GP62 Leopard Pro', 'In-depth review of the MSI GP62-2QEi781FD (Intel Core i7 5700HQ, NVIDIA GeForce GTX 950M, 15.6", 2.3 kg) ... The MSI GE series is already the manufacturer''s entry-level gaming series. ..... ', 839, 12, 'vega.jpg', ''),
(13, 5, 'Amazon Echo', 'Amazon Echo is a hands-free speaker you control with your voice. Echo connects to the Alexa Voice Service to play music, provide information, news, sports ...', 179, 13, 'vega.jpg', ''),
(14, 4, 'Apple Watch', 'The new Apple Watch is the ultimate device for your healthy life. Choose from a range of models including Apple Watch Series 2 and Apple Watch Nike+', 349, 14, 'vega.jpg', ''),
(15, 1, 'Google Pixel XL', 'XL 5.5" Phone 128GB Quite Black Cell Smart. GOOGLE PIXEL XL 5.5" Black 32GB TRUE ANDROID PHONE CDMA+GSM WORLD UNLOCKED', 649, 15, 'vega.jpg', ''),
(16, 2, 'Canon EOS 7D', 'The EOS 7D features a Canon-designed 18.0 Megapixel APS-C size CMOS sensor that captures such a high level of resolution it''s easy to crop images for ...', 889, 16, 'vega.jpg', ''),
(17, 1, 'Nexus 6P', 'All-metal design Unlocked, LTE smartphone with a powerful 2GHz Snapdragon 810 V2.1 Processor and the newest Android software, Android 6.0 marshmallow.', 499, 17, 'vega.jpg', '');
